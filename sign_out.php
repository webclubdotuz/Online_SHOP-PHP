...
if(isset($_POST['register'])){
	...
	if($row_cnt > 0){
		...
		$mysqli->query($query);
		$_SESSION['msgsucc'] = "Siz dizimnen ottiniz!!!";
...
<table>
<tr><td><label for="rname">Paydalaniwshi ati:</label>&nbsp;</td>
<td><input id="rname" name="rname" type="text" value="" placeholder="Sizdin atiniz!" pattern="^[a-zA-Z]+$" title="Username should contain only alphabets" required /></td></tr>
<tr><td><label for="rmail">Email:</label>&nbsp;</td>
<td><input id="rmail" name="rmail" type="email" value="" placeholder="Email!" required /></td></tr>
<tr><td><label for="rphone">Telefon:</label>&nbsp;</td>
<td><input id="rphone" name="rphone" type="text" value="" placeholder="Tel nomer" pattern="\d+" title="Phone no. should contain only numbers" required /></td></tr>
<tr><td><label for="raddress">Address:</label>&nbsp;</td>
<td><textarea id="raddress" name="raddress" value="" placeholder="Manzil" required></textarea></td></tr>
<tr><td><label for="rpass">Parol:</label>&nbsp;</td>
<td><input id="rpass" name="rpass" type="password" value="" placeholder="*******" required /></td></tr>
<tr><td><label for="cpass">Qaytadan parol:</label>&nbsp;</td>
