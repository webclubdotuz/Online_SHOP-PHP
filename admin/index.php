...
<title>Internet magazin | Admin Panel</title>
...
<h1>Admin Panel | Internet magazin</h1>
<p><form method="post" action="index.php">
<table>
<tr><td><label for="name">Admin:</label>&nbsp;</td>
<td><input id="name" name="name" type="text" value="" placeholder="Paydalaniwshi ati" required /></td></tr>
