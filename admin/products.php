...
<div id="templatemo_container">
	<div id="templatemo_menu">
    	<ul>
            <li><a id="sale" href="saleslist.php" class="">Sawda satiq</a></li>
            <li><a id="product" href="products.php" class="current">Onimler</a></li> 
...
?>
<button class="buy_now_button" style="float:right" onclick="addproduct()">Jana onim qosiw</button>
<h1>Onimler dizimi</h1>
    ...
    if ($results) { 
        ...
        {	
			...
			echo 'Price '.$obj->price.$currency;
			echo '<button class="buy_now_button" onclick="editproduct('. $obj->id .')" >Ozgertiw</button></div>';
			echo '<form action="products.php" method="post" name="pro" id="pro">';
			echo '<input type="hidden" name="proid" value="'.$obj->id.'" />';
			echo '<input type="submit" class="buy_now_button" name="delete" value="Oshiriw" onclick="return confirm(\'Are you sure to delete this product?\')" /></div></div></form>';
        }
