...
<div id="templatemo_container">
	<div id="templatemo_menu">
    	<ul>
            <li><a id="home" href="index.php" class="current">Bas bet</a></li>
        <?php if(isset($_SESSION['user'])){ ?>                     
            <li><a id="profile" href="profile.php" class="">My Profile</a></li> 
        <?php } else { ?>
        	<li><a href="#" onclick="login()">Kiriw</a></li>
            <li><a href="#" onclick="register()">Dizimnen otiw</a></li>  
        <?php } ?>
            <li><a href="#">Baylanis</a></li>
        <?php if(isset($_SESSION['user'])){ ?> 
			 <li><a href="logout.php">Shigiw</a></li>
		<?php } ?>
    	</ul>
    </div> <!-- end of menu -->